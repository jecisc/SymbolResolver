...
- **main** : This branch is a stable branch. Each version on this branch should be a stable release of Material Components for Seaside, and idealy each commit modifying the source code of the project should be tagged with a version number.
